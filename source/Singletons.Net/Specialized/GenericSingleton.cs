...
public sealed class GenericSingleton<T>
{
    ...
    /// <summary>
    /// Provides a thread-safe Singleton implementation for a specified type.
    /// This class ensures only one instance of the specified type is created and can be accessed globally.
    /// </summary>
    /// <typeparam name="T">
    /// The type that the Singleton pattern is applied to. The type must be a reference type
    ...
    /// This property is used internally to check if the singleton instance for the specified type has already been created or assigned.
    /// </summary>
