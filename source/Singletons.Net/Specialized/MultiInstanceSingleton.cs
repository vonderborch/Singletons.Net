    ...
    where TValue : class
{
    ...
    /// When accessing or creating a singleton instance without specifying a custom factory method, this default factory will be used.
    /// </summary>
    ...
    /// <param name="instanceFactory">An optional function to create the instance if it does not exist. If not provided, the default factory is used.</param>
    ...
    public static TValue GetInstance(TKey key, Func<TValue>? instanceFactory = null)
    {
        ...
        if (instanceFactory == null) throw new InvalidOperationException("No instance factory provided");
    ...
    public static void RemoveInstance(TKey key) => _instances.TryRemove(key, out _);
}
